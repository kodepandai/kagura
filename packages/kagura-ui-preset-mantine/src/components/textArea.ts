...
export const textArea: Callable<Partial<PresetTextArea>> = () => {
  return {
    textArea: {
      ...
      input: {
        "@apply leading-[1.55] appearance-none box-border text-[14px] w-full text-black block text-left min-h-[36px] px-3 rounded border border-[#ced4da] bg-white focus:outline-none focus:border-primary resize-none": {},
